...
%     Data.S.S3.PFCdif_temp = Data.S.S3.PFCdif(Data.subscripts);
%     Data.S.S3.PFCdif_temp_filtered = Data.S.S3.PFCdif_filtered(Data.subscripts);
    ...
    [Filter.PFCdif_A, Filter.PFCdif_B] = butter(4, 4/(Data.fs/2));
